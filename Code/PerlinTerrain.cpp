...
bool PerlinTerrain::Initialize(ID3D11Device* device, int terrainWidth, int terrainHeight)
{
	int index;
	float height = 0.0;
	bool result;
...
void PerlinTerrain::Render(ID3D11DeviceContext* deviceContext)
{
...
bool PerlinTerrain::CalculateNormals()
{
...
bool PerlinTerrain::InitializeBuffers(ID3D11Device* device)
{
	VertexType* vertices;
...
void PerlinTerrain::RenderBuffers(ID3D11DeviceContext* deviceContext)
{
	unsigned int stride;
	unsigned int offset;
...
bool PerlinTerrain::GenerateHeightMap(ID3D11Device* device, int seed)
{
	bool result;
...
bool PerlinTerrain::Update()
{
	return true;
}

float* PerlinTerrain::GetWavelength()
{
	return &m_wavelength;
}

float* PerlinTerrain::GetAmplitude()
{
	return &m_amplitude;
}
